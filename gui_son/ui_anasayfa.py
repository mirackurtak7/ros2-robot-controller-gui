...
################################################################################
## Form generated from reading UI file 'anasayfaOPwssC.ui'
##
...
"")
        ...
        self.radioButtonBaglantiDurumlari = QRadioButton(self.frame)
        self.radioButtonBaglantiDurumlari.setObjectName(u"radioButtonBaglantiDurumlari")
        self.radioButtonBaglantiDurumlari.setMaximumSize(QSize(30, 30))
        self.radioButtonBaglantiDurumlari.setLayoutDirection(Qt.LeftToRight)
        self.radioButtonBaglantiDurumlari.setStyleSheet(u"border:none;")
        ...
        self.radioButtonBaglantiDurumlari.raise_()
        self.text_9.raise_()
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.agv_net_durumu.setText(QCoreApplication.translate("MainWindow", u"OFFLINE", None))
